    ...
    return (
        <FooterContainer>
            <MainContainer maxWidth="xl" >
                <Grid
                    item alignContent={'center'} xs={12} sm={6}>
                    <LogoLink to="/">
                        <ReactLogo/>
                    </LogoLink>
                    <Description>Продукція створена з любов’ю та думкою про Вас </Description>
                    <Grid container gap={1} direction={'column'}>
                        <Typography variant="h6">Додаткова інформація за телефонами:</Typography>
                        <ContactPhone variant={'body1'}>
                            <Phone size={24}/>+38 0982177251
                        </ContactPhone>
                        <ContactPhone variant={'body1'}>
                            <Phone size={24}/>+38 0982177251
                        </ContactPhone>
