            ...
            <MainContainer maxWidth="xl">
                ...
                <TestimonialsContainer>
                    <TestimonialContainer>
                        ...
                        <TestimonialText>
                            “Дякую за швидке обслуговування і приємну комунікацію. Миючі засоби високої якості і дійсно
                            добре відмивають.”
                        </TestimonialText>
                    </TestimonialContainer>
                    <TestimonialContainer>
                        ...
                        <TestimonialText>
                            “Цілком задоволений товаром. Відправили швидко (2-3 дні). Замовляв антижир, наліт іржу цвіль
                            і для прочищення труб. Мені сподобалось.”
                        </TestimonialText>
                    </TestimonialContainer>
                    <TestimonialContainer>
                        <StarContainer>
